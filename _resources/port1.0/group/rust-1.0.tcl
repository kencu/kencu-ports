...
proc rust::set_environment {} {
    ...
    if { [option openssl.branch] ne "" } {
        ...
        rust::append_envs                   OPENSSL_DIR=${prefix}/libexec/openssl-${openssl.branch}
        compiler.cpath-prepend              ${prefix}/libexec/openssl-${openssl.branch}/include
        compiler.library_path-prepend       ${prefix}/libexec/openssl-${openssl.branch}/lib
        configure.pkg_config_path-prepend   ${prefix}/libexec/openssl-${openssl.branch}/lib/pkgconfig
    }
